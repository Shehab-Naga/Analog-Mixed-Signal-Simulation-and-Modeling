...
nodes_list = [R_Node_1 R_Node_2 L_Node_1 L_Node_2 C_Node_1 C_Node_2 V_Node_1 V_Node_2 I_Node_1 I_Node_2];
...
figure;
grid on 
title('magnitude and phase of V(1) vs frequency')
yyaxis left
...
figure;
grid on 
title('magnitude and phase of V(3) vs frequency')
yyaxis left
